...
class RelayRoleAuto extends Auto implements RelayRole {
	...
	public get user(): RelayUser {
		...
		if (!user) {
			console.warn("[RelayRoleAuto] user not in local cache", this.relayRole.user, "role", this.relayRole.id);
			return {
...
class FolderRoleAuto extends Auto implements FolderRole {
	...
	public get user(): RelayUser {
		...
		if (!user) {
			console.warn("[FolderRoleAuto] user not in local cache", this.folderRole.user, "role", this.folderRole.id);
			return {
